...
if(NOT _PC_IPOPT_FOUND)
  set(IPOPT_DIR_TEST $ENV{IPOPT_DIR}/build)
  if(IPOPT_DIR_TEST)
    set(IPOPT_BUILD_DIR $ENV{IPOPT_DIR}/build)
  else()
    set(IPOPT_BUILD_DIR /usr            CACHE PATH "Path to IPOPT build directory")
  endif()

  set(IPOPT_INCLUDE_DIRS ${IPOPT_BUILD_DIR}/include/coin)
  find_library(IPOPT_LIBRARIES ipopt ${IPOPT_BUILD_DIR}/lib
                                   ${IPOPT_BUILD_DIR}/lib/coin
                                   NO_DEFAULT_PATH)

  if(IPOPT_LIBRARIES)
    find_file(IPOPT_DEP_FILE ipopt_addlibs_cpp.txt ${IPOPT_BUILD_DIR}/share/doc/coin/Ipopt
                                                   ${IPOPT_BUILD_DIR}/share/coin/doc/Ipopt
                                                   NO_DEFAULT_PATH)
    ...
    if(IPOPT_DEP_FILE)
      ...
      foreach(LIB ${IPOPT_DEP})
        find_library(IPOPT_SEARCH_FOR_${LIB} ${LIB} ${IPOPT_BUILD_DIR}/lib
                                                    ${IPOPT_BUILD_DIR}/lib/coin
                                                    ${IPOPT_BUILD_DIR}/lib/coin/ThirdParty
                                                    NO_DEFAULT_PATH)
